  ...
  return (
        <View >
            {type === '1 Image' && <><View style={styles.root1}>
                <Image source={{ uri: image }} style={styles.image1} contentFit="cover" />
            </View></>}
            {type === '2 Image' && <><View style={styles.root2}>
                <View style={styles.col2} >
                    <Image source={{ uri: image }} style={styles.image2} contentFit="cover" />
                    <Image source={{ uri: image }} style={styles.image2} contentFit="cover" />
                </View>
            </View></>}
            {type === '3 Image' && <><View style={styles.root3}>
                ...
                <View style={styles.col32}>
                    <Image source={{ uri: image }} style={styles.image3} contentFit="cover" />
                    <Image source={{ uri: image }} style={styles.image3} contentFit="cover" />
                </View>
            </View></>}
