  ...
  return (
        <View style={styles.divider}>
            <View style={styles.linewrapper}>
                { type === 'Horizontal'
                  ? <Svg style={styles.line} width="161" height="1" viewBox="0 0 161 1" fill="none">
                    <Line y1="0.5" x2="160.5" y2="0.5" stroke="#E1E5EB"/>
                </Svg>
                  : <Svg style={styles.line} width="1" height="24" viewBox="0 0 1 24" fill="none" >
            ...
            <View style={styles._linewrapper}>
                {type === 'Horizontal'
                  ? <Svg style={styles._line} width="161" height="1" viewBox="0 0 161 1" fill="none">
